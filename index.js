...
import { TWO_JS_HTML } from './language/extentions/extentions.js'
import { compile, interpred, interpredBrowser } from './language/misc/fs.js'
import { compileModule, decodeUrl, encodeUrl } from './language/misc/utils.js'
...
compile(readFileSync('./programms/ui.rs', 'utf8'), './dist/ui.html')
