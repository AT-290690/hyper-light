<- ["SKETCH"; "MATH"; "CONSOLE"] [UNIVERSE];
<- ["makescene"; "setlinewidth"; "setrotation"; "setposition"; "nofill"; "setfill"; "setstroke";  "update"; "background"; "makerectangle"; "width"; "height"] [SKETCH];
